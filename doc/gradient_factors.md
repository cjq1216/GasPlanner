...
This is the key options which defines the generated profile curve. For more details about this option see [Gradient factors article](./gradient_factors_bilingual.md) (full Chinese-English bilingual translation).
...
| High (30/70)     | Deep dives, decompression dives, hard conditions |
